...
- Design / product / role questions: call \`list_work_profiles\` then \`ask_teammate\`. Do not dump those only in this chat. The tool is non-blocking — finish the turn after asking.
